...
$search_query = '';
$sort_query = 'ORDER BY RAND()'; // Default to random ordering
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav ml-auto">
        <li class="nav-item active">
          <a class="nav-link" href="#" style="color: white; font-size: 1.2rem; font-weight: bold; text-shadow: 1px 1px 2px rgba(0, 0, 0, 0.3); transition: color 0.3s;">Home</a>
        </li>
        <li class="nav-item">
...
<br><br>
 ...
 /* Hero Banner */
 .hero-banner {
            background: url('https://www.disinfectionservices.com.sg/wp-content/uploads/2022/12/How-to-Clean-Disinfect-Your-Kids-Favorite-Toys.jpg') no-repeat center center/cover;
            height: 80vh;
            position: relative;
            display: flex;
...
<div class="hero-banner">
    <div class="hero-content">
        <h1>Welcome to Toy Paradise</h1>
        <p>Your one-stop shop for quality toys that bring smiles to kids and families! .</p>
        <a href="all_products.php" class="btn btn-primary btn-lg">Shop Now</a>
    </div>
</div>

<h2 style="text-align: center; padding: 20px 0; font-family: 'DM Serif Text', serif; font-weight: 400;">Featured Products</h2>
...
<style>
    ...
    .apply-button { /* Unique class for the Apply button */
        ...
        background-color: #007BFF; /* Apply button specific background color */
    }
    ...
    <div class="product-card"  style="background-color: #ade8f4;">
        ...
        <span class="badge bg-success" style="font-family: 'Prompt', sans-serif; font-weight: 400; font-style: normal;">In Stock</span>
         ...
         <!--   <p class="original-price" style="font-family: 'Prompt', sans-serif; font-weight: 400; font-style: normal;">Ksh<?php echo number_format($product['price'], 2); ?></p> -->
                     <p  style="font-family: 'Prompt', sans-serif; font-weight: 400; font-style: normal;"><?php echo $product['review_count']; ?> reviews</p>
            ...
            <a class="add-to-cart" href="product.php?id=<?php echo $product['id']; ?>" class="btn" style="font-family: 'DM Serif Text', serif; font-weight: 400; font-style: normal; background-color:  #007BFF;">View Product</a>
        </div>
    </div>
    <?php } ?>
</div>
...
<div class="button-container" style="text-align: center;">
    <a href="all_products.php" class="btn" style="font-family: 'DM Serif Text', serif; font-weight: 400; font-style: normal;">View All Products</a>
</div>
<br>
<style>
      <style>
        * {
        ...
        .banner .left {
            flex: 7;
            background-image: url('https://images.ctfassets.net/2djrn56blv6r/63KKR8wAPEaxLGr8xThRP4/3e0ea178bd23c45afd28d579ab5237e8/akc-pupill-hdr-new-new.jpg?fm=webp&q=75&w=1920');
        ...
        @media screen and (max-width: 768px) {
            ...
            .banner .right h1, .banner .right p {
                text-shadow: 2px 2px 5px rgba(255, 255, 255, 1);
            }
        }
    </style>
 <a href="pet.php" class="banner" style="text-decoration: none; color: inherit;">
        <div class="left"></div>
        <div class="right">
            <h1>Welcome to Puppy Paradise</h1>
            <p>Your trusted partner for premium pet grooming services. Pamper your pup today!</p>
    ...
    <i class="fa-brands fa-whatsapp"></i>
            ...
            <div class="col-xs-6 col-md-3">
                ...
                <ul class="footer-links" style="font-family: 'Prompt', sans-serif; font-weight: 400; font-style: normal;">
                    ...
                    <li><a href="pet.php">Puppy Paradise</a></li>
                </ul>
            </div>
        </div>
        <hr>
